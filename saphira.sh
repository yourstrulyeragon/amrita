...
tput setaf 6; echo -e "After connecting to Tor network, swipe the termux screen left to right to reveal a menu. Click New Session and run this program again. To exit, click exit in the notification menu. You can also press Ctrl+c multiple times, but pls don't tire yourself \n\n "
